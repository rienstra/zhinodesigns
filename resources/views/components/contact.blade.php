    ...
    <div data-aos="fade-up" data-aos-delay="50" class="max-w-2xl mx-5 md:mx-auto py-20 ">
        ...
        <dl class="mt-10 space-y-4 text-base leading-7 text-white">
            <div class="flex gap-x-4">
                ...
                <dd>Zeilmakersstraat 15<br>8601 WT Sneek</dd>
            </div>
            <div class="flex gap-x-4">
                <dt class="flex-none">
                ...
                <dd><a class="hover:text-white" href="tel:06 42963213">06-42963213</a></dd>
            </div>
            <div class="flex gap-x-4">
                <dt class="flex-none">
                ...
                <dd><a class="hover:text-white" href="mailto:gavin@zhinodesigns.com">gavin@zhinodesigns.com</a></dd>
            </div>
        </dl>
    </div>
</div>
